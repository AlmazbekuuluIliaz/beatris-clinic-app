...
def seed() -> None:
    ...
    try:
        ...
        schedules = [
            ...
            models.DoctorSchedule(
                id="59f37f1c-3353-4ab0-95fe-f1c434850f90",
                specialist_id="3cf1afdc-08ad-42c0-a4e1-2624752a837d",
                schedule_date=date(2026, 6, 7),
                start_time=time(12, 0),
                end_time=time(20, 0),
                is_available=True,
            ),
            models.DoctorSchedule(
                id="eb823661-e57f-496a-8670-ffb81224bc87",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                schedule_date=date(2026, 6, 8),
                start_time=time(14, 0),
                end_time=time(18, 0),
                is_available=True,
            ),
            models.DoctorSchedule(
                id="16ae807b-9175-4246-8463-62b23dd0c2aa",
                specialist_id="0632b426-905f-4ee1-8bfb-520c44eb5500",
                schedule_date=date(2026, 6, 9),
                start_time=time(9, 0),
                end_time=time(18, 0),
                is_available=True,
            ),
            models.DoctorSchedule(
                id="9746bc34-4058-4b94-a77e-2a5b7939d51f",
                specialist_id="3cf1afdc-08ad-42c0-a4e1-2624752a837d",
            ...
            models.DoctorSchedule(
                id="95e2d29f-d885-4ac9-8d92-5f7fc78c2dd3",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                schedule_date=date(2026, 6, 12),
                start_time=time(14, 0),
                end_time=time(19, 0),
                is_available=True,
            ),
            models.DoctorSchedule(
                id="eb16d675-c8d4-477a-ace2-4e242c256151",
                specialist_id="0632b426-905f-4ee1-8bfb-520c44eb5500",
                schedule_date=date(2026, 6, 13),
                start_time=time(14, 0),
                end_time=time(20, 0),
                is_available=True,
            ),
            models.DoctorSchedule(
                id="c2e39e4d-f92a-435b-b6aa-cd8e4170dcb0",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                schedule_date=date(2026, 6, 14),
                start_time=time(12, 0),
                end_time=time(20, 0),
                is_available=True,
            ),
            models.DoctorSchedule(
                id="31b08ce3-4171-4a26-8c22-824d7626fd41",
                specialist_id="3cf1afdc-08ad-42c0-a4e1-2624752a837d",
            ...
            models.DoctorSchedule(
                id="a58d6296-86ac-435b-88e2-97706c3bb2eb",
                specialist_id="0632b426-905f-4ee1-8bfb-520c44eb5500",
                schedule_date=date(2026, 6, 16),
                start_time=time(9, 0),
                end_time=time(18, 0),
                is_available=True,
            ),
            models.DoctorSchedule(
                id="fdf93896-1dcc-402d-bb04-d6de444387df",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                schedule_date=date(2026, 6, 17),
                start_time=time(10, 0),
                end_time=time(18, 0),
                is_available=True,
            ),
            models.DoctorSchedule(
                id="26895d83-91e5-40d4-a570-94230152396d",
                specialist_id="3cf1afdc-08ad-42c0-a4e1-2624752a837d",
                schedule_date=date(2026, 6, 18),
                start_time=time(12, 0),
                end_time=time(20, 0),
                is_available=True,
            ),
        ...
        appointments = [
            ...
            models.Appointment(
                id="b1234567-abcd-4123-8ef0-123456789abc",
                patient_id=None,
                patient_name="Камила Жанатовна",
                patient_phone="+77001112233",
                service_id="a7b8c9d0-7777-4071-8c9d-7e8f90123456",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                appointment_date=date(2026, 6, 14),
                appointment_time=time(14, 0),
                status=models.AppointmentStatus.CONFIRMED,
                comment="Контрольный осмотр",
            ),
            models.Appointment(
                id="c2345678-bcde-4234-9f01-23456789abcd",
                patient_id=None,
                patient_name="Юля Абдукаримова",
                patient_phone="+77002223344",
                service_id="b8c9d0e1-8888-4182-9d0e-8f9012345678",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                appointment_date=date(2026, 6, 13),
                appointment_time=time(16, 0),
                status=models.AppointmentStatus.PENDING,
                comment="Первичная консультация",
            ),
            models.Appointment(
                id="d3456789-cdef-4345-a012-3456789abcde",
                patient_id=None,
                patient_name="Юля Сатпаева",
                patient_phone="+77003334455",
                service_id="a7b8c9d0-7777-4071-8c9d-7e8f90123456",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                appointment_date=date(2026, 6, 15),
                appointment_time=time(12, 0),
                status=models.AppointmentStatus.CONFIRMED,
                comment="Повторный приём",
            ),
            models.Appointment(
                id="e4567890-defa-4456-b123-456789abcdef",
                patient_id=None,
                patient_name="Жан Кенжебаев",
                patient_phone="+77004445566",
                service_id="b8c9d0e1-8888-4182-9d0e-8f9012345678",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                appointment_date=date(2026, 6, 16),
                appointment_time=time(11, 0),
                status=models.AppointmentStatus.CONFIRMED,
                comment="Консультация по результатам",
            ),
            models.Appointment(
                id="f5678901-efab-4567-c234-56789abcdef0",
                patient_id=None,
                patient_name="Айбек Бай",
                patient_phone="+77005556677",
                service_id="a7b8c9d0-7777-4071-8c9d-7e8f90123456",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
            ...
            models.Appointment(
                id="a6789012-fabc-4678-d345-6789abcdef01",
                patient_id=None,
                patient_name="Камила Жан",
                patient_phone="+77006667788",
                service_id="cfb67935-1d0e-4f75-b78e-b1a96f7bcf5c",
                specialist_id="fc108ab7-29b8-4cb0-89bf-e522408594c0",
                appointment_date=date(2026, 6, 18),
                appointment_time=time(12, 30),
                status=models.AppointmentStatus.CANCELLED,
                comment="Не удалось дозвониться",
            ),
            models.Appointment(
                id="b7890123-abcd-4789-e456-789abcdef012",
                patient_id=None,
                patient_name="Юля Лан",
                patient_phone="+77007778899",
                service_id="b8c9d0e1-8888-4182-9d0e-8f9012345678",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                appointment_date=date(2026, 6, 19),
                appointment_time=time(15, 0),
                status=models.AppointmentStatus.PENDING,
                comment="Онлайн-запись через сайт",
            ),
            models.Appointment(
                id="c8901234-bcde-4890-f567-89abcdef0123",
                patient_id=None,
                patient_name="Дамир Нурланов",
                patient_phone="+77008889900",
                service_id="a7b8c9d0-7777-4071-8c9d-7e8f90123456",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
            ...
            models.Appointment(
                id="d9012345-cdef-4901-a678-9abcdef01234",
                patient_id=None,
                patient_name="Ольга Петрова",
                patient_phone="+77009990011",
                service_id="cfb67935-1d0e-4f75-b78e-b1a96f7bcf5c",
                specialist_id="fc108ab7-29b8-4cb0-89bf-e522408594c0",
                appointment_date=date(2026, 6, 24),
                appointment_time=time(13, 0),
                status=models.AppointmentStatus.PENDING,
                comment="Повторный визит",
            ),
            models.Appointment(
                id="e0123456-defa-4012-b789-abcdef012345",
                patient_id=None,
                patient_name="Светлана Михайлова",
                patient_phone="+77001002030",
                service_id="a7b8c9d0-7777-4071-8c9d-7e8f90123456",
                specialist_id="fde77300-d61d-4ad0-958e-1ddc7d7726ca",
                appointment_date=date(2026, 6, 26),
